    ...
    const [deleting, setDeleting] = useState(null);
      ...
      const handleDeleteVideo = async (videoId) => {
        ...
        try {
          ...
          // Clear uploaded video if it's the one being deleted
          if (uploadedVideo?.id === videoId) {
                  ...
                  <div className="alert alert-success">
                    <div className="w-full">
                      ...
                      <div className="mt-3">
                        <button
                          type="button"
                          onClick={() => handleDeleteVideo(uploadedVideo.id)}
                          disabled={deleting === uploadedVideo.id}
                          className="btn btn-sm btn-error"
                        >
                          {deleting === uploadedVideo.id ? 'Deleting...' : 'Delete Video'}
                        </button>
                      </div>
                    </div>
                  </div>
