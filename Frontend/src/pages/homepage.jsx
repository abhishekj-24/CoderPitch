...
return (
    <div className="min-h-screen flex justify-center items-start relative overflow-hidden bg-gradient-to-br from-gray-950 via-gray-800 to-gray-950">
        
        {/* navigation bar */}
        <nav className="navbar bg-gray-800/80 backdrop-blur-md border-b border-gray-700 shadow-lg px-4 fixed top-0 w-full z-50">
                ...
                {isLoading ? (
                    ...
                    <>
                        {filterproblem.map((problem,index) => (
                            <div key={problem._id} className="card bg-gray-800/60 backdrop-blur-md border border-gray-700 shadow-2xl hover:shadow-indigo-500/20 hover:border-indigo-500/30 transition-all duration-300 transform hover:-translate-y-1">
                                <div className="card-body p-6">
                                    <div className="flex items-center justify-between">
                                        <h2 className="card-title text-white text-xl font-bold">
                                            <NavLink to={`/problem/${problem._id}`} className="hover:text-indigo-400 transition-colors duration-300 flex items-center gap-2">
                                                <span className="text-gray-400 font mr-0  pr-2">{index+1}.</span>
                                                {problem.title}
                                            </NavLink>
                                        </h2>
